            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Basket Additions"
                    ),
                ),
                (
                    "num_purchases",
                    models.PositiveIntegerField(
                        default=0, db_index=True, verbose_name="Purchases"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "num_product_views",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Product Views"
                    ),
                ),
                (
                    "num_basket_additions",
                ...
                (
                    "num_orders",
                    models.PositiveIntegerField(
                        default=0, db_index=True, verbose_name="Orders"
                    ),
                ),
                (
                    "num_order_lines",
                    models.PositiveIntegerField(
                        default=0, db_index=True, verbose_name="Order Lines"
                    ),
                ),
                (
                    "num_order_items",
                    models.PositiveIntegerField(
                        default=0, db_index=True, verbose_name="Order Items"
                    ),
                ),
                (
                    "total_spent",
                ...
                (
                    "date_last_order",
                    models.DateTimeField(
                        blank=True, verbose_name="Last Order Date", null=True
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "query",
                    models.CharField(
                        max_length=255, db_index=True, verbose_name="Search term"
                    ),
                ),
                (
                    "date_created",
