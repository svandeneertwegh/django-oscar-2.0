        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "iso_3166_1_a3",
                    models.CharField(
                        max_length=3, verbose_name="ISO 3166-1 alpha-3", blank=True
                    ),
                ),
                (
                    "iso_3166_1_numeric",
                    models.CharField(
                        max_length=3, verbose_name="ISO 3166-1 numeric", blank=True
                    ),
                ),
                (
                    "printable_name",
                ...
                (
                    "is_shipping_country",
                    models.BooleanField(
                        default=False, db_index=True, verbose_name="Is shipping country"
                    ),
                ),
            ],
            options={
