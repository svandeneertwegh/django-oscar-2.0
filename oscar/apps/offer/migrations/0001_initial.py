    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    oscar.models.fields.ExtendedURLField(
                        verbose_name="URL redirect (optional)", blank=True
                    ),
                ),
                (
                    "date_created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(to="catalogue.Product", on_delete=models.CASCADE),
                ),
                (
                    "range",
                    models.ForeignKey(to="offer.Range", on_delete=models.CASCADE),
                ),
            ],
            options={},
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filepath",
                    models.CharField(max_length=255, verbose_name="File Path"),
                ),
                ...
                (
                    "error_message",
                    models.CharField(
                        max_length=255, verbose_name="Error Message", blank=True
                    ),
                ),
                (
                    "date_processed",
                    models.DateTimeField(verbose_name="Date Processed", null=True),
                ),
                (
                    "num_new_skus",
                    models.PositiveIntegerField(
                        verbose_name="Number of New SKUs", null=True
                    ),
                ),
                (
                    "num_unknown_skus",
                    models.PositiveIntegerField(
                        verbose_name="Number of Unknown SKUs", null=True
                    ),
                ),
                (
                    "num_duplicate_skus",
                    models.PositiveIntegerField(
                        verbose_name="Number of Duplicate SKUs", null=True
                    ),
                ),
                (
                    "range",
