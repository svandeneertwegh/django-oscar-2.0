    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "card_type",
                    models.CharField(max_length=128, verbose_name="Card Type"),
                ),
                (
                    "name",
                ...
                (
                    "partner_reference",
                    models.CharField(
                        max_length=255, verbose_name="Partner Reference", blank=True
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(max_length=128, verbose_name="Label", blank=True),
                ),
                (
                    "order",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "txn_type",
                    models.CharField(max_length=128, verbose_name="Type", blank=True),
                ),
                (
                    "amount",
                    models.DecimalField(
                ...
                (
                    "status",
                    models.CharField(max_length=128, verbose_name="Status", blank=True),
                ),
                (
                    "date_created",
