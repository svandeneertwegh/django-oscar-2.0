    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=128, verbose_name="Name", blank=True),
                ),
                (
                    "users",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, verbose_name="Number in stock", null=True
                    ),
                ),
                (
                    "num_allocated",
                    models.IntegerField(
                        blank=True, verbose_name="Number allocated", null=True
                    ),
                ),
                (
                    "low_stock_threshold",
                    models.PositiveIntegerField(
                        blank=True, verbose_name="Low Stock Threshold", null=True
                    ),
                ),
                (
                    "date_created",
