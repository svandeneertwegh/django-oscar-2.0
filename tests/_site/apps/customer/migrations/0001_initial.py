        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_body_template",
                    models.TextField(
                        blank=True, verbose_name="Email Body Template", null=True
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        max_length=75, db_index=True, verbose_name="Email", blank=True
                    ),
                ),
                (
                    "key",
                    models.CharField(
                        max_length=128, db_index=True, verbose_name="Key", blank=True
                    ),
                ),
                (
                    "status",
                ...
                (
                    "date_confirmed",
                    models.DateTimeField(
                        blank=True, verbose_name="Date confirmed", null=True
                    ),
                ),
                (
                    "date_cancelled",
                    models.DateTimeField(
                        blank=True, verbose_name="Date cancelled", null=True
                    ),
                ),
                (
                    "date_closed",
                    models.DateTimeField(
                        blank=True, verbose_name="Date closed", null=True
                    ),
                ),
                (
                    "product",
